...
confusionMatrix(predictions, TST$classe)
```
The random forest model is far superior than the previously run models judged by the cross-validation accuracy. As the accuracy is sufficiently high (Accuracy rate of .997) no further models will be tested.
...
The final model built to predict the quality of the exercise has an accuracy rate of 0.997, when applied on the test sample. That means that the estimated out-of sample-error is (1-0.997) is 0.003 or 0.3%. 
